...
const MainContent = () => {
    ...
    const totalPrpducts = 100;
    const totalPages = Math.ceil(totalPrpducts / itemsPerPage);
        ...
        <section className=" p-5">
            <div className="mb-5">
                ...
                <div className="flex flex-col sm:flex-row justify-between items-center mt-5">
                    ...
                    {/* privious */}
                    <button onClick={() => handlePageChange(currentPage - 1)} disabled={currentPage === 1} className="border px-4 py-2 mx-2 roundered-full">Previous</button>

                    <div className="flex flex-w-wrap-justify-center">
                        {/* pagination button  1,2,3,4,5*/}
                    ...
                    {/* next */}
                    <button onClick={() => handlePageChange(currentPage + 1)} disabled={currentPage === totalPages} className="border px-4 py-2 mx-2 roundered-full">Next</button>
